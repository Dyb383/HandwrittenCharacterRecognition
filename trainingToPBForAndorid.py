...
def train(model, training_data, callback=True, batch_size=256, epochs=10):
   ...
   # if callback == True:
    ...
    OutputModel(saver=tf.train.Saver(), model=model, input_node_names=['conv2d_1_input'], output_node_name='dense_2/Softmax')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--file', type=str, help='Path .mat file data', required=False)
    ...
    training_data = load_data('C:\Test\emnist-byclass.mat', width=28, height=28, max_=None, verbose=True)
